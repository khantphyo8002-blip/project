                                ...
                                <table class="table table-bordered table-striped ">
                                    ...
                                    <tbody class="align-middle">
                                        <?php
                                            ...
                                            $getdata = mysqli_query($conn, $getmessagedata);
                                            $i = 1;

                                            while($ctdata = mysqli_fetch_array($getdata)):

                                        ?>
                                        <tr>
                                            <td> <?php echo $i++ ?> </td>
                                            <td> <?php echo $ctdata['ct_id'] ?> </td>
                                            <td> <?php echo $ctdata['ct_name'] ?> </td>
                                            <td> <?php echo $ctdata['ct_phone'] ?> </td>
                                            <td> <?php echo $ctdata['ct_email'] ?> </td>
                                            <td> <?php echo $ctdata['ct_subject'] ?> </td>
                                            <td> <?php echo $ctdata['ct_message'] ?> </td>
                                            <td> <?php echo $ctdata['ct_date'] ?> </td>
                                            <td>
                                                <a href="message_del.php?id=<?php echo $ctdata['ct_id'] ?>" class="btn btn-outline-danger">Delete</a>
                                            </td>
                                        </tr>
